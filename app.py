...
class sql:
    ...
    def create_table():
        ...
        try:
            ...
            jaiganesh = psycopg2.connect(host='localhost',
                                    user='postgres',
                                    password='Jai@1997',
                                    database='retail_forecast')
            cursor = jaiganesh.cursor()
    ...
    def data_migration():
        ...
        try:
            f = pd.read_csv(r'D:\Guvi_projects\retail_sales_forecast\df_sql.csv')
            df = pd.DataFrame(f)
    ...
    def predict_weekly_sales():
        ...
        if button:
            with st.spinner(text='Processing...'):
                ...
                with open(r'D:\Guvi_projects\retail_sales_forecast\model1_markdown.pkl', 'rb') as f:
                    model = pickle.load(f)
